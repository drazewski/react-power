...
import './styles.css';
import {moveCard, removeCard, updateCardServer} from "../../actions/card";
...
class CardDetails extends React.Component {
    ...
    onRename(title) {
        this.props.dispatch(updateCardServer(this.props.card.id, { title }));
    }
        ...
        return (
            <aside className="cardDetails">
                <section className="cardDetails__modal">
                    <div className="cardDetails__body">
                        <div className="cardDetails__details">
                            <h2 className="cardDetails__details__title">
                                <EditableHeader onChange={this.onRename}>{card.title}</EditableHeader>
                            </h2>
                    ...
                    <span className="cardDetails__modal__close" onClick={this.close}>
                        <i className="fa fa-close" />
                    </span>
                </section>

                <div className="cardDetails__backdrop" onClick={this.close} />
            </aside>
        );
    }
}
